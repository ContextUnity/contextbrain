...
from contextbrain.core.interfaces import BaseProvider, IRead, IWrite, secured
from contextbrain.core.tokens import ContextToken
from contextbrain.modules.retrieval.rag.settings import get_effective_data_store_id
...
async def generate_with_grounding(
    ...
    **Raises:**
    ...
    try:
        ...
        raise ProviderError(
            "Google Gen AI SDK not installed. Install with: pip install 'google-genai' or install contextbrain with vertex extras: pip install 'contextbrain[vertex]'",
    ...
    async def read(
        ...
        *,
        ...
        env = ContextUnit(
            ...
            provenance=["provider:vertex_grounding"],
        )
        return [env]
