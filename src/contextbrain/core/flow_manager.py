...
from contextbrain.core.config import Config, FlowConfig, get_core_config
from contextbrain.core.interfaces import BaseConnector, BaseProvider, BaseTransformer
from contextbrain.core.registry import ComponentFactory, Registry
...
class FlowManager:
    ...
    async def run(self, flow: FlowConfig, *, token: ContextToken) -> FlowResult:
        ...
        # - "context"/"agent_context": return the ContextUnit envelope to the caller to attach to state
