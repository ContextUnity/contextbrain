...
class ComponentFactory:
    ...
    def create_provider(name: str, **kwargs: Any) -> Any:
        ...
        providers = {
            "vertex": (
                "contextbrain.modules.providers.storage.vertex",
                "VertexProvider",
            ),
            "postgres": (
                "contextbrain.modules.providers.storage.postgres.provider",
                "PostgresProvider",
            ),
            "gcs": ("contextbrain.modules.providers.storage.gcs", "GCSProvider"),
        }
    ...
    def create_connector(name: str, **kwargs: Any) -> Any:
        ...
        connectors = {
            "web": ("contextbrain.modules.connectors.web", "WebSearchConnector"),
            "web_scraper": (
                "contextbrain.modules.connectors.web",
                "WebScraperConnector",
            ),
            "file": ("contextbrain.modules.connectors.file", "FileConnector"),
            "rss": ("contextbrain.modules.connectors.rss", "RSSConnector"),
            "api": ("contextbrain.modules.connectors.api", "APIConnector"),
        }
    ...
    def create_transformer(name: str, **kwargs: Any) -> Any:
        ...
        transformers = {
            "metadata_mapper": (
                "contextbrain.modules.transformers.metadata",
                "MetadataMapper",
            ),
            "summarizer": (
                "contextbrain.modules.transformers.summarization",
                "Summarizer",
            ),
        }
...
BUILTIN_AGENTS: dict[str, str] = {
    "extract_query": "contextbrain.cortex.nodes.rag_retrieval.extract.ExtractQueryAgent",
    "detect_intent": "contextbrain.cortex.nodes.rag_retrieval.intent.DetectIntentAgent",
    "retrieve": "contextbrain.cortex.nodes.rag_retrieval.retrieve.RetrieveAgent",
    "suggest": "contextbrain.cortex.nodes.rag_retrieval.suggest.SuggestAgent",
    "generate": "contextbrain.cortex.nodes.rag_retrieval.generate.GenerateAgent",
    "routing": "contextbrain.cortex.nodes.rag_retrieval.routing.RoutingAgent",
}
...
def scan(plugin_dir: Path) -> None:
    ...
    This allows users to extend ContextBrain with custom components
