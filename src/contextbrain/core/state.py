...
During migration, `contextbrain.cortex.state` continues to define the LangGraph
...
class _BaseState(BaseModel):
    ...
    # Optional internal auth context (ContextUnit protocol token or compatible object).
