...
extensions (AccessManager, require_permission) that integrate with contextbrain Config.
...
from contextbrain.core import Config, get_core_config
...
class AccessManager:
    ...
    Service-specific extension that integrates TokenBuilder with contextbrain Config.
    """
    ...
    def verify_envelope_write(self, envelope: ContextUnit, token: ContextToken) -> None:
        """Backward compatibility alias for verify_unit_write."""
        self.verify_unit_write(envelope, token)
