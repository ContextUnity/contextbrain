...
Requirements:
    pip install contextbrain[models-openai,models-anthropic,models-hf-hub]
...
async def test_text_generation(provider: str, model_key: str) -> bool:
    ...
    from contextbrain.modules.models.registry import model_registry
    from contextbrain.modules.models.types import ModelRequest, TextPart
...
async def test_image_input(provider: str, model_key: str) -> bool:
    ...
    from contextbrain.modules.models.registry import model_registry
    from contextbrain.modules.models.types import ImagePart, ModelRequest, TextPart
...
async def test_audio_asr(provider: str, model_key: str) -> bool:
    ...
    from contextbrain.modules.models.registry import model_registry
    from contextbrain.modules.models.types import AudioPart, ModelRequest
...
async def test_video_input(provider: str, model_key: str, video_uri: str) -> bool:
    ...
    from contextbrain.modules.models.registry import model_registry
    from contextbrain.modules.models.types import ModelRequest, TextPart, VideoPart
