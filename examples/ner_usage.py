...
from contextbrain.modules.transformers.ner import NERTransformer
...
async def example_llm_ner():
    ...
    # Access entities
    metadata = enriched.payload.get("metadata", {}) if enriched.payload else {}
    entities = metadata.get("ner_entities", [])
    entities_by_type = metadata.get("ner_entities_by_type", {})
