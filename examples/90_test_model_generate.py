...
Notes:
  - For OpenAI/OpenRouter/local providers: install extras `contextbrain[models]`
  - For HF transformers: install extras `contextbrain[hf-transformers]`
"""
...
from contextbrain.modules.models.types import (
    FinalTextEvent,
    ModelRequest,
    TextDeltaEvent,
    TextPart,
